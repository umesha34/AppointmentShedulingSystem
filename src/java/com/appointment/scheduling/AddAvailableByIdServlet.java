 ...
 * @author krgay
 */
public class AddAvailableByIdServlet extends HttpServlet {
	...
	try (PrintWriter out = response.getWriter()) {
	    ...
	    out.println("<html>");
	    out.println("<head>");
	    out.println("<title>Servlet AddAvailableByIdServlet</title>");
	    out.println("</head>");
	    out.println("<body>");
            ...
            try{
                ...
                if(consultantdao.addNewCA(consultant)){
                    response.sendRedirect("sessionConsultant.jsp");
                }else{
