...
List<appointments> appointmentList = appointment.getAllAppoinmentsByJsid(Integer.toString(jobseeker.getId()));
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav ml-auto">
                        ...
                        <a href="myReservation.jsp" class="nav-item nav-link active">My Reservations</a>
