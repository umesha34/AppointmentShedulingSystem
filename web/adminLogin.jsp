                                ...
                                <div>
                                        <form action="LoginServlet" method="post">
                                            <div class="group">
                                                    ...
                                                    <input style="border:none; padding:15px 20px; border-radius:25px; background:rgba(255,255,255,.1);" id="user" type="text" placeholder="Email" name="aemail" required>
                                            </div>
                                            <div class="group">
                                                    <label for="pass" class="label">Password</label>
                                                    <input style="border:none; padding:15px 20px; border-radius:25px; background:rgba(255,255,255,.1);" id="pass" type="password" placeholder="Password" name="apassword"required> 
                                            </div>
                                            <div class="group">
