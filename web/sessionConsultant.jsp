            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav ml-auto">
                        ...
                        <a href="sessionConsultant.jsp" class="nav-item nav-link active">Session</a>
                        <a href="contactConsultant.jsp" class="nav-item nav-link">Contact</a>
                        <a href="myReservationConsultant.jsp" class="nav-item nav-link">My Reservations</a>
                ...
                <div class="row">
                    <div class="col-12">
                        <ul id="class-filter">
                            ...
                            <li><a href="makeConsultant.jsp" class="filter">Create</a></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="class-wrap">
                            ...
                            <div class="class-text">
                                <div class="class-teacher">
                                    ...
                                    <h3>${temp.email}</h3>
                                    <a href="createAppointment.jsp?id=${temp.id}">+</a>
                                </div>
